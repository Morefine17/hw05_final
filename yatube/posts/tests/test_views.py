...
class PostsPageTest(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.post_page = Post.objects.bulk_create([
            Post(text='Тест 1', author=cls.user, group=cls.group,
                 image=uploaded),
            Post(text='Тест 2', author=cls.user, group=cls.group,
                 image=uploaded),
            Post(text='Тест 3', author=cls.user, group=cls.group,
                 image=uploaded),
            Post(text='Тест 4', author=cls.user, group=cls.group,
                 image=uploaded),
            Post(text='Тест 5', author=cls.user, group=cls.group,
                 image=uploaded),
            Post(text='Тест 6', author=cls.user, group=cls.group,
                 image=uploaded),
            Post(text='Тест 7', author=cls.user, group=cls.group,
                 image=uploaded),
            Post(text='Тест 8', author=cls.user, group=cls.group,
                 image=uploaded),
            Post(text='Тест 9', author=cls.user, group=cls.group,
                 image=uploaded),
            Post(text='Тест 10', author=cls.user, group=cls.group,
                 image=uploaded),
            Post(text='Тест 11', author=cls.user, group=cls.group,
                 image=uploaded),
            Post(text='Тест 12', author=cls.user, group=cls.group,
                 image=uploaded),
            Post(text='Тест 13', author=cls.user, group=cls.group,
                 image=uploaded)
        ])
